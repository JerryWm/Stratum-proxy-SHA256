define(["app/Common", "app/UnPackArray"], function(Common, UnPackArray) {
	...
	function viewAcceptedRejectedShares(acceptedCount, rejectedCount) {
		return `<span style="color: #28a745; text-shadow: -3px -2px 5px;">${Common.intOrNA(acceptedCount)}</span> /
		<span style="color: #dc3545; text-shadow: -3px -2px 5px;" >${Common.intOrNA(rejectedCount)}</span>`;
	}
	...
	function viewHashRate(hashrate) {
		return `<div class="hrtb">
				<div>
					<div>${Common.doubleOrNA_kStyle(hashrate["current"])}</div>
					<div>${Common.doubleOrNA_kStyle(hashrate["5"])}</div>
					<div>${Common.doubleOrNA_kStyle(hashrate["10"])}</div>
					<div>${Common.doubleOrNA_kStyle(hashrate["15"])}</div>
					<div>${Common.doubleOrNA_kStyle(hashrate["30"])}</div>
					<div>${Common.doubleOrNA_kStyle(hashrate["60"])}</div>
					<div>${Common.doubleOrNA_kStyle(hashrate["all"])}</div>
				</div>
			</div>
		`;
	}
	...
	function viewHashRateFullHtmlInTable(hashrate) {
		return `
					...
					<tbody>
						<tr>
							<td>${Common.doubleOrNA_kStyle(hashrate["current"])}</td>
							<td>${Common.doubleOrNA_kStyle(hashrate["5"])}</td>
							<td>${Common.doubleOrNA_kStyle(hashrate["10"])}</td>
							<td>${Common.doubleOrNA_kStyle(hashrate["15"])}</td>
							<td>${Common.doubleOrNA_kStyle(hashrate["30"])}</td>
							<td>${Common.doubleOrNA_kStyle(hashrate["60"])}</td>
							<td>${Common.doubleOrNA_kStyle(hashrate[60*2])}</td>
							<td>${Common.doubleOrNA_kStyle(hashrate[60*3])}</td>
							<td>${Common.doubleOrNA_kStyle(hashrate[60*6])}</td>
							<td>${Common.doubleOrNA_kStyle(hashrate[60*12])}</td>
							<td>${Common.doubleOrNA_kStyle(hashrate[60*24])}</td>
							<td>${Common.doubleOrNA_kStyle(hashrate["all"])}</td>
						</tr>
					</tbody>
		`;
	}
	...
	return {
		...
		viewAcceptedRejectedShares: viewAcceptedRejectedShares,
	};
